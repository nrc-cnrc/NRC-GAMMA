...
:------------------------:
<img src="figure/gas_meter.png" alt="The Itron 400A gas diaphragm meter" width="20%" height="20%">
...
:------------------------:
<img src="figure/image_capturing_sys.png" alt="The image capturing system" width="20%" height="20%">
